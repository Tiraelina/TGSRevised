...
namespace TGS
{
    public class TGSAbilities
    {
        ...
        private static void InitAbilLookups()
        {
            ...
            HeroToBaseAbility.Add(UNIT_NAKA_SUCCUBUS_MULTIROLE_HERO, ABILITY_A04B_AURA_OF_FIERY_LUST_Z_MISTRESS_ALLURADEL);
            ...
            HeroToBaseAbility.Add(UNIT_HAPM_THANE_DAMAGE_HERO_STR, ABILITY_A0JQ_DEADLY_STRIKE_Z_FALSTAD);
            ...
            HeroToBaseAbility.Add(UNIT_HHKL_BARD_SUPPORT_HERO_AGI_MULTI, ABILITY_A0O1_PENNY_PINCH_Z_FAERALINA);
