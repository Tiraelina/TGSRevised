...
public class HeroData
{
    ...
    private static void InitAbilLookups()
    {
        ...
        HeroToBaseAbility.Add(UNIT_ORKN_SHADOW_HUNTER_HERO, ABILITY_A0O4_SOUL_STEAL_DANCE_Z_ROKHAN_DEFUNCT);
        ...
        HeroToBaseAbility.Add(UNIT_HAPM_THANE_HERO_STR, ABILITY_A0JQ_DEADLY_STRIKE_Z_FALSTAD);
    }
